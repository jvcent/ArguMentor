...
export const Landing = () => {
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center h-screen bg-blue-800">
            <p className="text-white text-4xl mb-10 main-font">ArguMentor</p>
            <p className="text-white main-font">ArguMentor is your study companion, helping you practice and improve your knowledge. Enter your topics or upload notes for effective learning. Start your learning journey today!</p>
            <button
